...
const Insurances = (props) => {
    ...
    let [searchTab, setSearchTab] = useState("Active Only");
    ...
    const performSearch = async (nextPage, searchKey, additional = searchTab) => {
        ...
        let filterData = await getPatientInsurances(practiceId, patientId, searchKey, limit, last, additional)
        ...
        <div className="Demographics text-left">
            ...
            <div className="sectionOne">
                <div className="buttonTabs">
                    <Button variant="primary" className={getButtonClass("Active Only")} onClick={changeTab}>
                        Active Only
                    </Button>
